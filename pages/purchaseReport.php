...
<?php
		$branch=$_SESSION['branch'];
		$qty=0;
		$query=mysqli_query($con,"select * from stockin natural join product natural join supplier where branch_id='$branch'and date(date)>='$start' and date(date)<='$end' and prod_id = '$prodId' order by date desc")or die(mysqli_error());
