...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 03, 2022 at 08:02 PM
...
(51, 1, 'has logged in the system at ', '2021-05-14 02:57:21'),
(52, 5, 'has logged in the system at ', '2021-09-29 01:54:18'),
(53, 5, 'has logged in the system at ', '2021-12-31 04:04:53'),
(54, 5, 'has logged out the system at ', '2021-12-31 10:28:21');
...
(3164, 2, 9, '36.70', '2017-02-21 21:31:20', 1, 1, '2017-04-21', '113.30', '81.58', '856.32', 'partially paid', '0.00', 0),
(3165, 2, 9, '0.00', '0000-00-00 00:00:00', 1, 1, '2017-05-21', '113.30', '81.58', '893.02', '', '0.00', 0),
(3166, 2, 9, '0.00', '0000-00-00 00:00:00', 1, 1, '2017-06-21', '113.30', '81.58', '893.02', '', '0.00', 0),
...
(3206, 2, 18, '0.00', '0000-00-00 00:00:00', 1, 1, '2021-06-11', '2719.20', '81.58', '2882.36', '', '0.00', 0),
...
(3216, 0, 44, '160.00', '2021-09-29 02:11:15', 5, 1, '2021-09-29', '160.00', '0.00', '0.00', 'paid', '0.00', 1916);
...
(5, 'LG 43\" UHD TV UH6100', '', '45000.00', 'tv.jpg', 5, 6, 1, 0, 4, '19898981'),
...
(8, 'SALE', 3, NULL, 96, 18, '2021-09-28 21:11:15', 1),
(9, 'SALE', 3, NULL, 9, 5, '2021-09-28 21:11:15', 1),
(10, 'SALE', 11, NULL, 107, 15, '2021-09-28 21:11:16', 1);
...
(44, 0, 5, '0.00', '0.00', '160.00', '0.00', '2021-09-29 02:11:15', 'cash', 1, '160.00');
...
--
-- Indexes for table `producttracker`
--
ALTER TABLE `producttracker`
  ADD PRIMARY KEY (`TransRef`);
...
--
ALTER TABLE `payment`
  MODIFY `payment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3217;
...
--
-- AUTO_INCREMENT for table `producttracker`
--
ALTER TABLE `producttracker`
  MODIFY `TransRef` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
